...
## **Backend Integration**
The backend for this application is developed using **Django REST Framework (DRF)**.  
It provides all APIs for:
- User Authentication (JWT)
- Role Management (Student, Admin, Super Admin)
- Event CRUD operations
- Registration handling with validation logic
