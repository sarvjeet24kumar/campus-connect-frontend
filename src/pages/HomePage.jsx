...
const HomePage = () => {
  ...
  useEffect(() => {
    const handleShowLogin = (event) => {
      setLoginType(event.detail.isAdmin ? 'admin' : 'student');
    ...
    <div className="space-y-8">
      ...
      <section className="rounded-2xl bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 p-8 text-white shadow-lg">
        <div className="mx-auto max-w-4xl text-center">
          <h1 className="mb-4 text-4xl font-bold md:text-5xl">Welcome to Campus Connect</h1>
          <p className="mb-8 text-lg text-indigo-100">
            Discover amazing events, register instantly, and manage everything in one place.
          </p>
      ...
      <section className="rounded-2xl bg-white p-6 shadow-sm">
        <h2 className="mb-6 text-2xl font-semibold text-slate-800">How It Works</h2>
        <div className="grid gap-6 md:grid-cols-3">
          <div className="rounded-lg border border-slate-200 p-4">
            ...
            <h3 className="mb-2 font-semibold text-slate-800">Create Account</h3>
            <p className="text-sm text-slate-600">
              Sign up as a student or get admin access from a super admin to start managing events.
            </p>
          </div>
          <div className="rounded-lg border border-slate-200 p-4">
            ...
            <h3 className="mb-2 font-semibold text-slate-800">Explore Events</h3>
            <p className="text-sm text-slate-600">
          ...
          <div className="rounded-lg border border-slate-200 p-4">
            ...
            <h3 className="mb-2 font-semibold text-slate-800">Manage Everything</h3>
            <p className="text-sm text-slate-600">
              Admins can create events, manage registrations, and track attendance in real-time.
            </p>
          </div>
        </div>
      </section>
